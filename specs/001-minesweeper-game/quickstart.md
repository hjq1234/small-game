...
- `advanced`: 30×16 board with 99 mines
- `custom`: User-defined board size and mine count

**In-Game Difficulty Changes:**
While playing, you can press:
- **1** to switch to Beginner difficulty
- **2** to switch to Intermediate difficulty
- **3** to switch to Advanced difficulty

The current difficulty is displayed in the top-left corner of the game window.
